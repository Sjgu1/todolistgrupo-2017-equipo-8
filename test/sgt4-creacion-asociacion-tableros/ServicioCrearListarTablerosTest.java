...
public class ServicioCrearListarTablerosTest{
  ...
  public void crearTableroUsuarioNoExisteCausaExcepcion(){
    ...
    // si intentamos generar un tablero con un nombre existente debe generar error
    //en este caso, controlamos que lo que limita es el nombre y no el que sea del mismo usuario
    @Test(expected=TableroServiceException.class)
    public void crearTableroConNombreDuplicadoDistintoUsuarioGeneraExcepcionTest(){
      long idUsuario=1000L;
      long idUsuario2=1001L;
      TableroService tableroService=newTableroService();
      Tablero tablero=tableroService.creaTablero(idUsuario,"tablero 1");
      tablero=tableroService.creaTablero(idUsuario2,"tablero 1");
    }
